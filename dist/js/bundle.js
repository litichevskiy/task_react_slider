...
var REMOVE_IMAGES = exports.REMOVE_IMAGES = 'REMOVE_IMAGES';
...
var Preloader = function Preloader(_ref) {
    var isLoad = _ref.isLoad;

    if (!isLoad) return _react2.default.createElement('div', { style: { display: 'none' } });
...
Preloader.propTypes = {
    isLoad: _propTypes2.default.bool.isRequired
};
...
*/
var aa=__webpack_require__(2),ca=__webpack_require__(1),m=__webpack_require__(12),p=__webpack_require__(5),v=__webpack_require__(3),da=__webpack_require__(13),ea=__webpack_require__(14),fa=__webpack_require__(15),ha=__webpack_require__(6);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(19), __webpack_require__(48)(module)))
...
var DEFAULT_QUANTITY = 5; // items preview ( minimum 2 )
var LEAF_THROUGH_TIME = 10000; // ms
...
var App = function (_Component) {
    ...
    function App(props) {
        ...
        _this.getNextPreview = _this.getNextPreview.bind(_this);
        _this.getPreviousPreview = _this.getPreviousPreview.bind(_this);
        return _this;
    }
    ...
    _createClass(App, [{
        ...
        value: function addImages() {
            ...
            var to = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : DEFAULT_QUANTITY - 1;

            _index3.default.getList(from, to).then(function (response) {
                _this2.props.dispatch(pageActions.addImages(response));
        ...
        key: 'deleteImages',
        value: function deleteImages(from, to) {
            this.props.dispatch(pageActions.removeImages({ from: from, to: to }));
        }
    }, {
        key: 'getNextPreview',
        value: function getNextPreview(from, to) {
            this.addImages(from, to);
        }
    }, {
        key: 'getPreviousPreview',
        value: function getPreviousPreview(from, to) {
...
var storage = function () {
  ...
  return {
    getList: function getList(from, to) {
      return new Promise(function (resolve, reject) {
        to = to + 1;
        var result = list.slice(from, to);

        if (to >= total) resolve({ list: result, isNext: false });else resolve({ list: result, isNext: true });
      });
    }
  };
}();
...
var _Arrow = __webpack_require__(67);

var _Arrow2 = _interopRequireDefault(_Arrow);

var _CreateImage = __webpack_require__(68);

var _CreateImage2 = _interopRequireDefault(_CreateImage);

var _getParentNode = __webpack_require__(69);

var _getParentNode2 = _interopRequireDefault(_getParentNode);
...
var Slider = function (_Component) {
    ...
    function Slider(props) {
        ...
        if (_this.props.quantity < 2) throw 'quantity - can not be less than 2';
        ...
        _this.memoryIndex;
        _this.from = 0;
        _this.to = _this.props.quantity - 1;
        _this.nextImgs = _this.nextImgs.bind(_this);
        _this.previousImgs = _this.previousImgs.bind(_this);
        _this.nextBlockImgs = _this.nextBlockImgs.bind(_this);
        _this.previousBlockImgs = _this.previousBlockImgs.bind(_this);
        _this.setNewActiveIndex = _this.setNewActiveIndex.bind(_this);
        _this.stopLeafThrough = _this.stopLeafThrough.bind(_this);
        _this.startLeafThrough = _this.startLeafThrough.bind(_this);
        return _this;
    }
    ...
    _createClass(Slider, [{
        ...
        value: function componentWillReceiveProps() {
            ...
            this.newProps = true;
            setTimeout(function () {
                return _this2.newProps = false;
            }, 200);
        }
    }, {
        key: 'startLeafThrough',
        value: function startLeafThrough() {
            var _this3 = this;

            this.intevral = setInterval(function () {
                _this3.nextImgs();
            }, this.props.leafThroughTime);
        }
    }, {
        key: 'stopLeafThrough',
        value: function stopLeafThrough() {
            clearInterval(this.intevral);
        }
    }, {
        key: 'componentDidUpdate',
        value: function componentDidUpdate() {
            var listImages = this.refs.wrapperImages.children;
        ...
        key: 'setMemoryIndex',
        value: function setMemoryIndex(index) {
            this.memoryIndex = index;
        }
    }, {
        key: 'nextImgs',
        value: function nextImgs() {
        ...
        key: 'previousBlockImgs',
        value: function previousBlockImgs() {
            var quantity = this.props.quantity;
            this.from = this.from - quantity;
            this.to = this.to - quantity;
        ...
        value: function setNewActiveIndex(event) {
            var target = event.target;
            var id = void 0;
            if (target.tagName === 'UL') return;
            target = (0, _getParentNode2.default)(target, 'LI');
        ...
        value: function render() {
            ...
            var list = this.props.sliderList;
            var active = this.state.activeIndex;
            var activeItem = list[active];
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'title_large_slide' },
                    activeItem ? activeItem.text : ''
                ),
                _react2.default.createElement(
                    'div',
                    { ref: 'containerSlide', className: 'container_large_slide' },
                    ...
                    _react2.default.createElement(
                        'ul',
                        { className: 'list_large_images', ref: 'wrapperImages' },
                        list.map(function (item, index) {
                            return _react2.default.createElement(
                                'li',
                                { key: index, className: 'wrapper_images' },
                                _react2.default.createElement(_CreateImage2.default, {
                                    className: "large_slide",
                                    src: item.hero,
                                    isNewProps: _this4.newProps })
                            );
                        })
                    ),
                    _react2.default.createElement(_Arrow2.default, {
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'container_list_preview' },
                    _react2.default.createElement(_Arrow2.default, {
                    ...
                    _react2.default.createElement(
                        'ul',
                        { className: 'list_preview', onClick: this.setNewActiveIndex },
                        list.map(function (item, index) {
                            return _react2.default.createElement(
                                'li',
                                {
...
Slider.propTypes = {
    sliderList: _propTypes2.default.array.isRequired,
    getNextPreview: _propTypes2.default.func.isRequired,
    getPreviousPreview: _propTypes2.default.func.isRequired,
...
Arrow.propTypes = {
    handlerClick: _propTypes2.default.func.isRequired,
...
var HIDE_PRELOADER = 100; // ms

var CreateImage = function (_Component) {
    _inherits(CreateImage, _Component);

    function CreateImage(props) {
        _classCallCheck(this, CreateImage);

        var _this = _possibleConstructorReturn(this, (CreateImage.__proto__ || Object.getPrototypeOf(CreateImage)).call(this, props));

        _this.state = {
            isReady: false
        };

        _this.imgReady = _this.imgReady.bind(_this);
        return _this;
    }
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement('img', {
                    ...
                    alt: props.alt }),
                _react2.default.createElement(_Preloader2.default, { isLoad: !this.state.isReady ? true : false })
            );
        }
    }]);
...
CreateImage.propTypes = {
    ...
    isNewProps: _propTypes2.default.bool.isRequired
};
...
function slider() {
    ...
    switch (action.type) {
        case _slider.ADD_IMAGES:
            ...
            break;
        case _slider.REMOVE_IMAGES:
            var total = action.payload.to - (action.payload.from - 1);
            return _extends({}, state, {
